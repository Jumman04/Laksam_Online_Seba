...
public class Coaching_Centre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coaching_centre);
        getSupportActionBar().setTitle("কোচিং সেন্টার এর তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("coaching_center_sub_text", R.string.coaching_center_sub_textview_01);
        hashMap.put("coaching_center_sub_details_text", R.string.coaching_center_sub_details_textview_01);
        arrayList.add(hashMap);


        //==========================================================================================
        //==========================================================================================
        Coaching_Centre.MyAdapter myAdapter = new Coaching_Centre.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            call_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        String phoneNumber = "01791-377679";
            ...
            all_sub_textview.setText(hashMap.get("coaching_center_sub_text"));
            all_sub_details_textview.setText(hashMap.get("coaching_center_sub_details_text"));
...
} //------------------------Coaching_Centre Bundle Method Line End Here