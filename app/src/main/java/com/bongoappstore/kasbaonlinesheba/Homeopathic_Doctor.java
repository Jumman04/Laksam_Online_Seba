...
public class Homeopathic_Doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homeopathic_doctor);
        getSupportActionBar().setTitle("হোমিওপ্যাথিক ডাক্তারের তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("sim_service_headline_text", R.string.homeo_doctor_home_text_01);
        hashMap.put("sim_service_dial_code_text", R.string.homeo_doctor_home_treatment_text_01);
        arrayList.add(hashMap);


        //==========================================================================================
        //==========================================================================================
        Homeopathic_Doctor.MyAdapter myAdapter = new Homeopathic_Doctor.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                doctor_profile_img.setImageResource(R.drawable.homeopathy_icon);
            ...
            doctor_details_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        View alertCustomdialog = LayoutInflater.from(Homeopathic_Doctor.this).inflate(R.layout.doctor_alert_dialog_layout, null);
                        //initialize alert builder.
                        AlertDialog.Builder alert = new AlertDialog.Builder(Homeopathic_Doctor.this).setCancelable(true);

                        //set our custom alert dialog to tha alertdialog builder
                        alert.setView(alertCustomdialog);

                        doctor_name_text = alertCustomdialog.findViewById(R.id.doctor_name_text);
                        doctor_name_text.setText(R.string.homeo_doctor_name_text_01);


                        doctor_details_text = alertCustomdialog.findViewById(R.id.doctor_details_text);
                        doctor_details_text.setText(R.string.homeo_doctor_details_text_01);
                        ...
                        serial_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intentcall = new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel", "01759-264401", null));
            ...
            message_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("sms:" + "01759-264401"));
...
} //------------------------Homeopathic_Doctor Method Line End Here