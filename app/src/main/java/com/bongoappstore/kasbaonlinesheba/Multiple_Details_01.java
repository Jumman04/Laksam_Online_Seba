...
public class Multiple_Details_01 extends AppCompatActivity {

    RecyclerView recyclerView;

    public static ArrayList<HashMap<String, String>> donnerarrayList = new ArrayList<>();
    Multiple_Details_01.DonnerAdapter donnerAdapter = new Multiple_Details_01.DonnerAdapter(donnerarrayList);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setNavigationBarColor(ContextCompat.getColor(this, R.color.purple_500));
        setContentView(R.layout.activity_multiple_details01);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Multiple_Details_01.this));
    ...
    private class DonnerAdapter extends RecyclerView.Adapter<Multiple_Details_01.DonnerAdapter.DonnerViewHolder> {
        ...
        @NonNull
        @Override
        public Multiple_Details_01.DonnerAdapter.DonnerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            LayoutInflater inflater = getLayoutInflater();
            View view = inflater.inflate(R.layout.custom_item_01, parent, false);


            return new Multiple_Details_01.DonnerAdapter.DonnerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull Multiple_Details_01.DonnerAdapter.DonnerViewHolder holder, int position) {
            ...
            holder.userCALL.setOnClickListener(view -> {
                ...
                if (!PHONE.isEmpty()) {
                    ...
                    Toast.makeText(Multiple_Details_01.this, "Number Not Available", Toast.LENGTH_SHORT).show();
                }
            });
            //==============================================================================
            //==============================================================================
...
} //-----------------------Multiple_Details_01 Bundle Method End