...
public class Wood_Furniture_Shop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wood_furniture_shop);
        getSupportActionBar().setTitle("কাঠের ফার্নিচার শপের তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("courier_service_name_text", R.string.wood_furniture_shop_name_text_01);
        hashMap.put("courier_service_address_text", R.string.wood_furniture_shop_details_text_01);
        ...
        Wood_Furniture_Shop.MyAdapter myAdapter = new Wood_Furniture_Shop.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                all_profile_image.setImageResource(R.drawable.joy_furniture_logo);
            ...
            call_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        String phoneNumber = "01718-038274";
...
} //----------------Wood_Furniture_Shop Bundle Method End