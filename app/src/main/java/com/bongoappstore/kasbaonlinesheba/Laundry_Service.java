...
public class Laundry_Service extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("লন্ড্রি সার্ভিস শপের তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("courier_service_name_text", R.string.laundry_shop_name_text_01);
        hashMap.put("courier_service_address_text", R.string.laundry_shop_details_text_01);
        ...
        Laundry_Service.MyAdapter myAdapter = new Laundry_Service.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                all_profile_image.setImageResource(R.drawable.laundry_service_icon);
            ...
            call_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        String phoneNumber = "01753-030923";
