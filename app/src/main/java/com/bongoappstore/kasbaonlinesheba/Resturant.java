...
public class Resturant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("কসবা রেস্টুরেন্ট এর তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("resturant_sub_text", R.string.resturant_sub_textview_09);
        hashMap.put("resturant_sub_details_text", R.string.resturant_sub_details_textview_09);
        arrayList.add(hashMap);

        //==========================================================================================
        //==========================================================================================
        Resturant.MyAdapter myAdapter = new Resturant.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 2) {
                ...
                all_profile_image.setImageResource(R.drawable.resturant_icon);
            ...
            if (position == 8) {
                ...
                all_profile_image.setImageResource(R.drawable.paker_ghar_icon);
            ...
            call_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 8) {
                        String phoneNumber = "01843728951";
                        Intent intent = new Intent(Intent.ACTION_DIAL);
                        intent.setData(Uri.parse("tel:" + phoneNumber));
                        startActivity(intent);
                    }
...
} //------------------------Resturant Bundle Method Line End Here