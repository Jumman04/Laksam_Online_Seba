...
public class Doctor_Gastroenterology extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_gastroenterology);
        getSupportActionBar().setTitle("গ্যাস্ট্রোএন্ট্রোলজি বিশেষজ্ঞ ডাক্তারের তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("sim_service_headline_text", R.string.gastroenterology_doctor_home_text_01);
        hashMap.put("sim_service_dial_code_text", R.string.gastroenterology_home_treatment_text_01);
        ...
        Doctor_Gastroenterology.MyAdapter myAdapter = new Doctor_Gastroenterology.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                doctor_profile_img.setImageResource(R.drawable.gastroantrolzi_icon);
            ...
            doctor_details_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        View alertCustomdialog = LayoutInflater.from(Doctor_Gastroenterology.this).inflate(R.layout.doctor_alert_dialog_layout, null);
                        //initialize alert builder.
                        AlertDialog.Builder alert = new AlertDialog.Builder(Doctor_Gastroenterology.this).setCancelable(true);

                        //set our custom alert dialog to tha alertdialog builder
                        alert.setView(alertCustomdialog);

                        doctor_name_text = alertCustomdialog.findViewById(R.id.doctor_name_text);
                        doctor_name_text.setText(R.string.gastroenterology_name_text_01);


                        doctor_details_text = alertCustomdialog.findViewById(R.id.doctor_details_text);
                        doctor_details_text.setText(R.string.gastroenterology_doctor_details_text_01);
