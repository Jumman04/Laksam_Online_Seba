...
public class Tailor_Craftsman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tailor_craftsman);
        getWindow().setNavigationBarColor(ContextCompat.getColor(this, R.color.purple_500));
        getSupportActionBar().setTitle("দর্জি কারিগর এর তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("courier_service_name_text", R.string.tailor_shop_name_text_01);
        hashMap.put("courier_service_address_text", R.string.tailor_shop_details_text_01);
        arrayList.add(hashMap);


        //==========================================================================================
        //==========================================================================================
        Tailor_Craftsman.MyAdapter myAdapter = new Tailor_Craftsman.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                all_profile_image.setImageResource(R.drawable.tailor_master_icon);
...
} //------------------------Board_Result Bundle Method Line End Here