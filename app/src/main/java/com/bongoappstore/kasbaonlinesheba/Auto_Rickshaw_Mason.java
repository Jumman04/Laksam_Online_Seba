...
public class Auto_Rickshaw_Mason extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auto_rickshaw_mason);
        ...
        hashMap = new HashMap<>();
        hashMap.put("beauty_parlour_sub_text", R.string.auto_rickshaw_sub_textview_01);
        hashMap.put("beauty_parlour_sub_details_text", R.string.auto_rickshaw_sub_details_textview_01);
        arrayList.add(hashMap);

        hashMap = new HashMap<>();
        hashMap.put("beauty_parlour_sub_text", R.string.auto_rickshaw_sub_textview_02);
        hashMap.put("beauty_parlour_sub_details_text", R.string.auto_rickshaw_sub_details_textview_02);
        arrayList.add(hashMap);


        //==========================================================================================
        //==========================================================================================
        Auto_Rickshaw_Mason.MyAdapter myAdapter = new Auto_Rickshaw_Mason.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            all_profile_image.setImageResource(R.drawable.auto_rickshaw_icon2);
            ...
            call_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        String phoneNumber = "01672453855";
                    ...
                    if (position == 0) {
                        String phoneNumber = "01620101710";
                        Intent intent = new Intent(Intent.ACTION_DIAL);
                        intent.setData(Uri.parse("tel:" + phoneNumber));
                        startActivity(intent);
                    }
