...
public class Sanitary_Mason extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sanitary_mason);
        getWindow().setNavigationBarColor(ContextCompat.getColor(this, R.color.purple_500));
        getSupportActionBar().setTitle("স্যানিটারি মিস্ত্রি এর তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("courier_service_name_text", R.string.sanitary_mason_name_text_01);
        hashMap.put("courier_service_address_text", R.string.sanitary_mason_details_text_01);
        arrayList.add(hashMap);


        //==========================================================================================
        //==========================================================================================
        Sanitary_Mason.MyAdapter myAdapter = new Sanitary_Mason.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                all_profile_image.setImageResource(R.drawable.sanitary_sabuj);
            ...
            call_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        String phoneNumber = "01943-663636";
...
} //------------------------Sanitary_Mason Bundle Method Line End Here