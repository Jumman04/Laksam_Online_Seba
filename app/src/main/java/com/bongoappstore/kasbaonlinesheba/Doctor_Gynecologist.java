...
public class Doctor_Gynecologist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_gynecologist);
        getSupportActionBar().setTitle("গাইনী বিশেষজ্ঞ ডাক্তারের তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("sim_service_headline_text", R.string.gyne_doctor_home_text_01);
        hashMap.put("sim_service_dial_code_text", R.string.gyne_doctor_home_sub_text_01);
        arrayList.add(hashMap);


        hashMap = new HashMap<>();
        hashMap.put("sim_service_headline_text", R.string.gyne_doctor_home_text_02);
        hashMap.put("sim_service_dial_code_text", R.string.gyne_doctor_home_sub_text_02);
        arrayList.add(hashMap);
        ...
        Doctor_Gynecologist.MyAdapter myAdapter = new Doctor_Gynecologist.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                doctor_profile_img.setImageResource(R.drawable.gynecologist_icon);
            ...
            message_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("sms:" + "01726-989603"));
            ...
            doctor_details_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        View alertCustomdialog = LayoutInflater.from(Doctor_Gynecologist.this).inflate(R.layout.doctor_alert_dialog_layout, null);
                        //initialize alert builder.
                        AlertDialog.Builder alert = new AlertDialog.Builder(Doctor_Gynecologist.this).setCancelable(true);

                        //set our custom alert dialog to tha alertdialog builder
                        alert.setView(alertCustomdialog);

                        doctor_name_text = alertCustomdialog.findViewById(R.id.doctor_name_text);
                        doctor_name_text.setText(R.string.gyne_doctor_name_text_01);


                        doctor_details_text = alertCustomdialog.findViewById(R.id.doctor_details_text);
                        doctor_details_text.setText(R.string.gyne_doctor_details_text_01);
                    ...
                    if (position == 1) {
                        ...
                        doctor_name_text = alertCustomdialog.findViewById(R.id.doctor_name_text);
                        doctor_name_text.setText(R.string.gyne_doctor_name_text_02);


                        doctor_details_text = alertCustomdialog.findViewById(R.id.doctor_details_text);
                        doctor_details_text.setText(R.string.gyne_doctor_details_text_02);
...
} //------------------------Doctor_Gynecologist Method Line End Here
