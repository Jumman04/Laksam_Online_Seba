...
public class Painter_Masson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_painter_masson);
        getSupportActionBar().setTitle("পেইন্ট মেস্ত্রী এর তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("kazi_office_sub_text", R.string.paint_masson_sub_text_01);
        hashMap.put("kazi_office_sub_details_text", R.string.paint_masson_sub_details_text_01);
        ...
        //==========================================================================================
        //==========================================================================================
        Painter_Masson.MyAdapter myAdapter = new Painter_Masson.MyAdapter();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                all_profile_image.setImageResource(R.drawable.paint_nuzrul_islam);
            ...
            message_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        String myNumber = "01820-904970";
                        String mySms = "এখানে আপনার message লিখুন";
            ...
            call_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position == 0) {
                        ...
                        String phoneNumber = "01820-904970";
