...
public class Dish_Service extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dish_service);
        getSupportActionBar().setTitle("ডিস সার্ভিস প্রতিষ্ঠানের তালিকা");
        ...
        hashMap = new HashMap<>();
        hashMap.put("courier_service_name_text", R.string.dish_service_name_text_01);
        hashMap.put("courier_service_address_text", R.string.dish_service_details_text_01);
        ...
        Dish_Service.MyAdapter myAdapter = new Dish_Service.MyAdapter();
    ...
    } //--------------OnCreate Bundle Method End Here
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                ...
                all_profile_image.setImageResource(R.drawable.kasba_dish_cable_logo);
